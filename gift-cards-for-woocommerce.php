    ...
    if ( $notice_link ) {
        ...
        <div class="notice notice-error">
            <p>
                ...
                echo wp_kses_post(
                    sprintf(
                        __( 'My Plugin has been deactivated because it cannot be used on WordPress.com-hosted websites. %s', 'gift-cards-for-woocommerce' ),
                        '<a href="' . esc_url( $notice_link ) . '" target="_blank" rel="noopener">' . __( 'Learn more', 'gift-cards-for-woocommerce' ) . '</a>'
                    )
                );
                ?>
            </p>
        ...
        wp_die(
            wp_kses_post(
                sprintf(
                    ...
                    __( 'Plugin Activation Blocked', 'gift-cards-for-woocommerce' ),
                    __( 'This plugin cannot be activated on WordPress.com-hosted websites. It is restricted due to concerns about WordPress.com policies impacting the community.', 'gift-cards-for-woocommerce' ),
                    esc_url( 'https://robertdevore.com/why-this-plugin-doesnt-support-wordpress-com-hosting/' ),
                    __( 'Learn more', 'gift-cards-for-woocommerce' )
                )
            ),
            esc_html__( 'Plugin Activation Blocked', 'gift-cards-for-woocommerce' ),
            [ 'back_link' => true ]
        );
    }
}
